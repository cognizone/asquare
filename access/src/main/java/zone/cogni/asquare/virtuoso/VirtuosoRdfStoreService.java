...
public class VirtuosoRdfStoreService implements RdfStoreService {
  ...
  public VirtuosoRdfStoreService(String rdfStoreUrl, String rdfStoreUser,
  ...
  public <R> R executeSelectQuery(Query query, QuerySolutionMap bindings,
      ...
      String context) {
    try (RDFConnection connection = getConnection(); QueryExecution queryExecution = connection
  ...
  public Model executeConstructQuery(Query query, QuerySolutionMap bindings) {
    try (RDFConnection connection = getConstructConnection(); QueryExecution queryExecution = connection
        .query(buildQuery(query, bindings))
    ) {
