...
public class EmbeddedContext {
  ...
  public Elasticsearch7Store mockElasticsearch7Store(Object originalBean, String originalBeanName) {
    ...
    String url = (String) Whitebox.getInternalState(originalBean, "url");
  ...
  public SparqlService mockVirtuosoSparqlService(Object originalBean, String originalBeanName) {
    ...
    String endpointUrl = (String) Whitebox.getInternalState(originalBean, "endpointUrl");
  ...
  public RdfStoreService mockVirtuosoRdfStoreService(Object originalBean, String originalBeanName) {
    ...
    String rdfStoreUrl = (String) Whitebox.getInternalState(originalBean, "rdfStoreUrl");
    String rdfStoreUser = (String) Whitebox.getInternalState(originalBean, "rdfStoreUser");
    String rdfStorePassword = (String) Whitebox.getInternalState(originalBean, "rdfStorePassword");
  ...
  public ExtFolderServiceFactory mockExtFolderServiceFactory(Object originalBean, String originalBeanName) {
    ...
    File extFolder = (File) Whitebox.getInternalState(originalBean, "extFolder");
