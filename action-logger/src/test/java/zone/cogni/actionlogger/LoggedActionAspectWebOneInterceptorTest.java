...
@Import(LoggedActionAspectWebOneInterceptorTest.TestConfiguration.class)
public class LoggedActionAspectWebOneInterceptorTest extends AbstractLoggedActionAspectTest {
