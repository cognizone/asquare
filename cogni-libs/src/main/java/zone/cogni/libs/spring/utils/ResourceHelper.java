...
public class ResourceHelper {
  ...
  public static void store(Resource source, File file) {
    try (OutputStream outputStream = FileHelper.openOutputStream(file)) {
      store(source, outputStream);
    }
    catch (IOException e) {
  ...
  public static void store(Resource source, OutputStream outputStream) {
